...
#define GATTS_CHAR_UUID_TEST_AA     0xAA01
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_WRITE_EVT: {
            ...
            if (gl_profile_tab[PROFILE_A_APP_ID].descr_handle == param->write.handle && param->write.len == 2){
                ...
                if (descr_value == 0x0001){
                	if (a_property & ESP_GATT_CHAR_PROP_BIT_NOTIFY){
                	    ...
                	    esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[PROFILE_A_APP_ID].char_handle[1],
        ...
        for (int i = 0; i < sizeof(notify_data); ++i)
        {
            notify_data[i] = param->write.value[i];
        }
        ...
        wifi_connect_unpack(notify_data);
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_A_APP_ID].service_handle = param->create.service_handle;
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEST_AA;
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        gl_profile_tab[PROFILE_A_APP_ID].char_handle[iindex++] = param->add_char.attr_handle;
...
static void gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
            ...
            if (gl_profile_tab[PROFILE_B_APP_ID].descr_handle == param->write.handle && param->write.len == 2){
                ...
                if (descr_value == 0x0001){
                    if (b_property & ESP_GATT_CHAR_PROP_BIT_NOTIFY){
                        ...
                        //the size of notify_data[] need less than MTU size
                        esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[PROFILE_B_APP_ID].char_handle[1],
                                                sizeof(notify_data), notify_data, false);
                    }
                }else if (descr_value == 0x0002){
    ...
    case ESP_GATTS_ADD_CHAR_EVT:
        ...
        gl_profile_tab[PROFILE_B_APP_ID].char_handle[1] = param->add_char.attr_handle;
...
void app_main()
{
    ...
    xTaskCreatePinnedToCore(&aws_iot_task, "aws_iot_task", 9216, NULL, 5, &awsHandle, 1);
    xTaskCreatePinnedToCore(&led_task, "led_task", 1024, NULL, 6, &ledHandle, 1);
